...
flags.DEFINE_integer('MSS_number', 2, 'Seed for the random generators (>=0)')
flags.DEFINE_integer('choose_num1', 2, 'Seed for the random generators (>=0)')
flags.DEFINE_integer('choose_num2', 2, 'Seed for the random generators (>=0)')
flags.DEFINE_integer('choose_num3', 2, 'Seed for the random generators (>=0)')
flags.DEFINE_integer('choose_num4', 2, 'Seed for the random generators (>=0)')
...
MSS_maps.append(Best_map)
MSS_maps.append(SM1_map)
...
if MSS_number>4:
    ...
    MSS_maps.append(SM4_map)


##
convs = []
for index_s in range(MSS_number):
    for index in range(embedding_dims):
            #print ("i:",index)
            t = Lambda(slice,output_shape=(maxlen,1,1),arguments={'index':index},
                       name='slice_'+str(index_s+1)+str(index+1))(MSS_maps[index_s])
